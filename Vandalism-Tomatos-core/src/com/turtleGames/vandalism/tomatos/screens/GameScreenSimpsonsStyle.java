...
import com.turtleGames.vandalism.tomatos.classes.WorldSimpsonsStyle;
import com.turtleGames.vandalism.tomatos.classes.WorldSimpsonsStyle.WorldListener;
...
public class GameScreenSimpsonsStyle implements Screen {
	...
	WorldRendererSimpsonsStyle worldRenderer;
	...
	public GameScreenSimpsonsStyle(Tomatos game) {
		...
		world = new WorldSimpsonsStyle(game, worldListener);
		worldRenderer = new WorldRendererSimpsonsStyle(spriteBatcher, modelBatcher, world);
