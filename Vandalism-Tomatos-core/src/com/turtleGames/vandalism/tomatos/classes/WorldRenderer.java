...
public class WorldRenderer {
	...
	public WorldRenderer(SpriteBatch spriteBatcher, ModelBatch modelBatcher,
			World world) {
		this.world = world;
	...
	private void renderBushKid() {
		...
		spriteBatcher.begin();
		spriteBatcher.draw(
				(Texture) world.game.assets.get("data/grassBackground.png"), 0,
				0, Gdx.graphics.getWidth(), 300);
		spriteBatcher.draw((Texture) world.game.assets.get("data/kid50.png"),
